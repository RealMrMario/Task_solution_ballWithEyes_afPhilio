...
float   eyeLeftRelativeX  = 5   ,  eyeLeftRelativeY  = 5;  // vi har lavede de her tal om til float fordi da zoomfactor er float og ikke kan arbejde sammen med et int. 
float   eyeRightRelativeX = 20  ,  eyeRightRelativeY = 5;  // vi har lavde 
...
void draw() {                         
  ...
  clear();
  ellipse(ballX, ballY + ballwalk, ballSize, ballSize); // + ballwalk med bally da det er y aksen vi skal have fat i for at den hopper. 
